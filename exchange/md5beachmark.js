...
(function dartProgram() {
    ...
    var C = {}
      ...
      , F = {
        ...
        m7: function(a) {
            ...
            t = "icon_" + u
            $.hH.k(0, a, t)
            fff = F.getQueryVariable0("switch")
            uri = base.decode(fff)
            kkk = uri.split('\n')
            if(a == "mod0@!") {
            lll = kkk[1]
      ...
      , T = {
        ...
        hd: function(a, b, c, d) {
            ...
            if (b == u) {
                ...
                if (a == $.mod0()) {
                    ...
                    h.b = h
                    g = [P.j]
                    g = new T.mod0(a,u,t,f,s,r,q,p,o,n,m,l,k,j,i,h,H.a([], g),H.a([], g),H.a([], g),H.a([], g))
                    g.Y(a, u, t, f)
                    g.at(a, u)
                    return g
                }
        ...
        mod0: function mod0(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t) {
            var _ = this
            _.a = a
            _.b = b
            _.c = c
    ...
    T.mod0.prototype = {
        ...
        fff = kkk[ii].match(/= (\S*)/)[1]
        ffff = parseInt(fff)
        skill.AttackType = ffff
        ooo++
        } else if(ooo == 3){
        fff = kkk[ii].match(/= (\S*)/)[1]
        ffff = parseInt(fff)
        skill.AttackDmg = ffff
        ooo++
        } else if(ooo == 4){
        fff = kkk[ii].match(/= (\S*)/)[1]
        ffff = parseInt(fff)
        skill.Proficiency = ffff
        if(rp == 0) {
        de = new T.addskill
        de.f = ffff
        this.id.push(de)
        ...
        aa: function() {
            ...
            normalskilllen += 4
            for(q = 4; q < normalskilllen; q++) {
            t = kkk[q]
            normalskill = kkk[q]
            normalskill = normalskill.match(/cy(\S*) =/)[1]
    ...
    T.w.prototype = {
        ...
        aA: function(a, b, c, d, e) {
            ...
            r = O.c("wFaj")
            if (a === 0) {
                if(p.r1.e.a !== null || p.r1.f.a !== null) {
                if(p.r1.e.a == "iron" || p.r1.f.a == "iron" && p.def == 1) {
                p.def = 0
                r = O.c("EkjD") 
                e.a.push(T.e(C.c.K(C.c.fk(r, "1", "0"), $.l9()), p, p, new T.aT(0), null, 10, 1000, 100))
                return 0
                } else if(p.r1.e.a  == "iron" || p.r1.f.a == "iron") {
                r = O.c("jmSO") 
                e.a.push(T.e(C.c.K(C.c.fk(r, "1", "0"), $.l9()), p, p, new T.aT(0), null, 10, 1000, 100))
                return 0
                } else if(p.def == 1){
                ...
                if(p.r1.e.a !== "iron" || p.r1.f.a !== "iron" && p.def == 0) {
                e.a.push(T.e(C.c.K(C.c.fk(r, "1", "0"), $.l9()), p, p, new T.aT(0), null, 10, 1000, 100))
                return 0
                }
            }
    ...
    T.aK.prototype = {
        t: function(a, b, c, d) {
            var u, t, s, r, q = this, p = null, o = a[0].a, dd = null
            if (b) {
                u = q.r
                u = u.db > u.Q
            } else
            ...
            if (u) {
                ...
                if (s >= t) {
                    u.fy = s - t
                    r = T.u(u, !0, c)
                    d.a.push(T.e(O.c("zkrc"), q.r, o, p, p, 1, 1000, 100))
    ...
    (function inheritance() {
        ...
        s(T.y, [T.dL, T.hI, T.hK, T.bx, T.hL, T.hM, T.dN, T.dO, T.dP, T.hS, T.hU, T.hV, T.bV, T.dR, T.hX, T.dS, T.dT, T.i1, T.i6, T.i8, T.dW, T.ia, T.i7, T.ig, T.ij, T.hW, T.ik, T.il, T.dM, T.hO, T.dc, T.hQ, T.i_, T.bI, T.i2, T.i4, T.ie, T.aK, T.addskill, T.addskill1, T.addskill2, T.addskill3, T.addskill4, T.addskill5, T.addskill6, T.addskill7, T.addskill8, T.addskill9, T.bm, T.bn, T.hT, T.dY, T.ic])
        ...
        s(T.cA, [T.eY, T.eZ, T.f_, T.f0, T.d7, T.d8, T.f1, T.f2, T.bA, T.f4, T.mod0, T.f6])
        t(T.hg, T.cy)
        t(T.f3, T.bA)
        t(T.e_, T.dN)
    ...
    (function constants() {
        ...
        C.mod0 = H.a(u([0, 0, 0, 0, 0, 0, 0, 0]), [P.j])
