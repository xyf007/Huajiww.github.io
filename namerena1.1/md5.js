...
(function dartProgram() {
    ...
    var C = {}
      ...
      , T = {
        ...
        m_e: function(a, b) {
            ...
            m.r = b.r
            m.ci = b
            m.e = T.du(b instanceof T.dC ? m.a5 = b.a5 : m.a5 = b)
            l = b.q
            l = H.a(l.slice(0), [H.n(l, 0)])
            m.q = l
            return m
    ...
    T.poss.prototype = {
        am: function(a, b, c) {
            if (a instanceof T.hi || a instanceof T.ho || a instanceof T.hh || a instanceof T.dC) {
            return !1
            }
            if(b) {
            if(c.fr > a.fr && c.V > a.V) {
            return !0
            }
            }
            if(c.fr > a.fr) {
        ...
        t: function(a, b, c, d) {
            var u, t, s = a[0].a,me,you,mename
            u = T.u(this.r, !0, c)
            me = this.r
            you = s
            this.r.x.d9(this.r)
            this.r.x.c.push(s)
            d.a.push(T.e(O.c("Whie"), this.r, this.r, null, null, 1, 1000, 100))
            d.a.push(T.e(O.c("BOjt"), this.r, s, null, null, 0, 1000, 100))
            d.a.push(T.e(O.c("Tqlz"), this.r, this.r, null, null, 0, 1000, 100))
        }
    }
    T.clone.prototype = {
        t: function(a, b, c, d) {
            var u, t, s, r, q = this, def = a[0].a, p = null,de,fe,ge
            de = def
            q.f = C.d.Z(q.f * 0.75)
                u = q.r.u
                s = q.r
            ...
            if (s.fr + s.db < c.m())
                q.f = C.b.ao(q.f, 1) + 1
            s = C.a.dcr(r.id, new T.hNe())
            if (s != null)
                s.f = q.f
            for (t = 0; t < 6; ++t)
                    r.u[t] = C.d.Z(de.u[t] * 0.6)
                r.u[7] = C.d.Z(de.u[7] * 0.5)
            r.Q = r.u[0]
            r.ch = r.u[1]
            r.cx = r.u[2] + 160
            r.cy = r.u[3]
            ...
            r.r = de.r
            s = d.a
            s.push(T.e(O.c("aCVC"), T.lV(q.r), q.r, p, p, 60, 1000, 100))
            q.r.x.aU(r)
            s.push(T.e(O.c("Jggp"), q.r, T.a1(r, r.fr), p, p, 0, 1000, 100))
        }
    }
    T.attadd.prototype = {
        ...
        t: function(a, b, c, d) {
            var u = a[0].a
              ...
              , x = 0
              , z = ""
            d.a.push(T.e(O.c("wCTO"), this.r, this.r, null, null, 10, 1000, 100))
            k += (c.m() & 15) + 30
            x = this.r.fr
            this.r.fr -= k
            d.a.push(T.e(O.c("wFaj"), this.r, T.a1(this.r,  x), new T.aT(k), null, k, 1000, 100))
            e = c.m() & 63
            if(e >= 0 && e < 9) {
            r = (c.m() & 3) + 9
            this.r.Q += r
            z = "[" + "\u653b" + "]"
            z += O.c("zjEW") 
            d.a.push(T.e(z, this.r, this.r, r, null, 0, 1000, 100))
            } else if(e >= 9 && e < 18) {
            r = (c.m() & 3) + 9
            this.r.ch += r
            z = "[" + "\u9632" + "]"
    ...
    T.power1.prototype = {
        ...
        al: function(a) {
            var u = this.x
            u.fy = 1.7976931348623157E+10308
            u.buff.power.condition = 1
        },
        aq: function(a, b) {
            if (--this.Q === 0)
                this.H(null, b)
    ...
    T.power.prototype = {
        ...
        am: function(a, b, c) {
            var u
            if (b) {
            if(c.buff.power.damage >= 4 && c.buff.power.condition == 0) {
            return !0
            }
            }
            return !1
        ...
        a8: function(a, b, c) {
            ...
            if (b) {
                u = T.d5(a) * a.L
                return a.r1.h(0, $.power()) != null ? u / 2 : u
            }
            return c.gbh()
        },
        t: function(a, b, c, d) {
            var u, t, s = this, r = null, q = s.r, p = d.a
            p.push(T.e(O.c("XlRI"), s.r, s.r, r, r, 60, 1000, 100))
            u = s.r
            u.j = u.j + u.cx
            u = q.r1
            t = H.o(u.h(0, $.power()), "$ipower1")
            if (t == null) {
                t = new T.power1(q)
                t.y = new T.ay(t)
                u.k(0, $.power(), t)
                ...
                t.Q += 4
            p.push(T.e(C.c.K(O.c("oDUY"), $.nf()), s.r, q, r, r, 0, 1000, 100))
        }
    }
    T.dS.prototype = {
        b5: function(a) {
    ...
    T.crazy.prototype = {
        ak: function(a, b, c, d, e) {
            var u, t, s = this.r, r = null, q = this.r, p = e.a
            if (this.r.fr - a <= 0 && this.r.buff.crazy.condition == 0 && d.m() < s.id[0].f && d.m() < 128 && s.bq(d)) {
            p.push(T.e(O.c("kGHm"), s, q, r, r, 60, 1000, 100))
            u = s
            u.j = u.j + u.cx
            u = q.r1
            t = H.o(u.h(0, $.crazy()), "$icrazy1")
            if (t == null) {
                t = new T.crazy1(q)
                t.y = new T.ay(t)
                u.k(0, $.crazy(), t)
                ...
                t.Q += 4
            p.push(T.e(C.c.K(O.c("BAgr"), $.nf()), s, q, r, r, 0, 1000, 100))
            p.push($.v())
            }
            return a
        },
    ...
    T.crazy1.prototype = {
        ...
        al: function(a) {
            var u = this.x
            u.buff.crazy.condition = 1
            u.buff.crazy.unbeatable = 1
        },
        aq: function(a, b) {
            if (--this.Q === 0)
                this.H(a, b)
        ...
        H: function(a, b) {
            ...
            u.E()
            if (u.fr > 0) {
                u.buff.crazy.unbeatable = 0
                t = b.a
                t.push($.v())
                t.push(T.ap(O.c("gCNs"), a, u))
                u.aA(u.buff.crazy.damage, u, T.a3(), a, b)
            }
        },
        $ip: 1
    }
    ...
    T.w.prototype = {
        ...
        Y: function(a, b, c, d) {
            ...
            l.buff.power = new Object()
            l.buff.power.damage = 0
            l.buff.power.condition = 0
            l.buff.crazy = new Object()
            l.buff.crazy.damage = 0
            l.buff.crazy.condition = 0
            l.buff.crazy.unbeatable = 0
        },
        cu: function(a) {
            var u, t = this
        ...
        eu: function(a, b, c) {
            var u, t, s, r, q, p, o = this, n = null, m = (b.m() & 63) < o.dy, l = o.fe(m, b, c),ter
            if (o.A)
                return
            if (l == null) {
                u = (b.m() & 15) + 8
        ...
        aA: function(a, b, c, d, e) {
            var u, t, s, r, q, p = this
            if(p.buff.crazy.unbeatable == 1) {
            p.buff.crazy.damage += a
            a = 0
            }
            if(a > 0){ 
            p.buff.power.damage += 1
            }
            if (a < 0) {
                u = p.fr
                t = u - a
    ...
    (function inheritance() {
        ...
        s(T.H, [T.y, T.hJ, T.crazy, T.hR, T.i0, T.i3, T.dU, T.dZ, T.bU, T.dQ, T.hZ, T.i5, T.dV, T.dX, T.i9, T.ih, T.im, T.io])
        s(T.y, [T.dL, T.hI, T.hK, T.bx, T.hL, T.hM, T.dN, T.dO, T.dP, T.hS, T.hU, T.hV, T.bV, T.clone, T.poss, T.attadd, T.dR, T.hX, T.dS, T.dT, T.i1, T.i6, T.i8, T.dW, T.ia, T.i7, T.ig, T.ij, T.hW, T.ik, T.il, T.dM, T.hO, T.dc, T.hQ, T.i_, T.bI, T.i2, T.i4, T.ie, T.aK, T.bm, T.bn, T.hT, T.dY, T.ic, T.power])
        s(T.M, [T.bf, T.co, T.dj, T.cG, T.power1, T.crazy1, T.aN, T.hz])
    ...
    (function lazyInitializers() {
        ...
        u($, "qS1", "power", function() {
            return O.i("\u6d01\ub57d\u630a")
        })
        u($, "qS2", "crazy", function() {
            return O.i("\u6683\u4cde\u83ea")
        })
        u($, "qG", "eE", function() {
            return O.i("\u6681\ub440\u426e\u6b1a")
