var e = function() {
	...
	function Ct(e, t, o, n) {
		function s() {
			try {
				for (var e, r = (new Date)
					.getTime(); rr(a.c.yb);)
					if (i = yt(a.c.yb.Ob) / yt(a.c.Ub), (new Date)
						.getTime() - r > 200) return n(i), Nt(s, 0), 0;
	...
	function zt(t, o, n) {
		function s() {
			try {
				for (var r, t = 0, _ = (new Date)
					.getTime(); rr(u.d.yb);)
					if (++t % 1e3 == 0 && (new Date)
						.getTime() - _ > 200) return a && (i = yt(u.d.yb.Z.g) / c, n(i)), Nt(s, 0), 0;
